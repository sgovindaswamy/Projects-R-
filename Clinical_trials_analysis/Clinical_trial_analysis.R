...
#They can be graded as LGG (Lower-Grade Glioma) or GBM (Glioblastoma Multiforme) depending on the histological/imaging criteria. 
#Clinical and molecular/mutation factors are also very crucial for the grading process. 
#Molecular tests are expensive to help accurately diagnose glioma patients.  
